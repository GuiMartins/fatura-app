...
import com.faturaapp.data.local.dao.CategoriaOverrideDao
...
@Database(
    entities = [
        ...
        SenhaPadraoEntity::class,
        CategoriaOverrideEntity::class,
    ],
    version = 2,
    exportSchema = false,
)
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract fun categoriaOverrideDao(): CategoriaOverrideDao
}
